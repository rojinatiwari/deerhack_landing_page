  ...
  return (
    <div className="max-w-5xl mx-auto p-6 space-y-8">
      ...
      <div className="text-center space-y-3">
        <h1 className="text-4xl font-bold text-blue-600">Slide Control</h1>
      </div>
                ...
                >
                  ...
                  <div className="flex items-center space-x-3">
                    <button
                      ...
                      className="p-2 text-red-600 hover:text-red-700 hover:bg-red-100 rounded-full transition-all duration-200 shadow-sm hover:shadow-md"
                      title="Remove file"
                    >
